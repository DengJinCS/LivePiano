...
sound = '/Users/atticus/Music/网易云音乐/kele.mp3'
piano = '/Users/atticus/Music/网易云音乐/nocturne.mp3'

#[inputSignal, fs] = soundfile.read(path)
inputSignal, fs = librosa.load(sound,sr=None)
